...
- Follow the existing component patterns in features/`,
  ...
  agentArchivedBannerRestore: "Restore",
  ...
  archiveDialogDescription: "\"{name}\" will be archived. It won't be assignable or mentionable, but all history is preserved. You can restore it later.",
  archiveDialogCancel: "Cancel",
  archiveDialogConfirm: "Archive",
  agentDetailCloud: "Cloud",
  agentDetailLocal: "Local",
  statusArchived: "Archived",
  thisAgentIsArchived: "This agent is archived. It cannot be assigned or mentioned.",
};
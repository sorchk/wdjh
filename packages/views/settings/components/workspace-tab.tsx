...
export function WorkspaceTab() {
    ...
    setConfirmAction({
      ...
      onConfirm: async () => {
        ...
        try {
          ...
          toast.error(e instanceof Error ? e.message : t.settings.workspace.failedToLeaveWorkspace);
        } finally {
          setActionId(null);
        }
      },
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.error(e instanceof Error ? e.message : t.settings.workspace.failedToDeleteWorkspace);
    } finally {
      setActionId(null);
    }
  };
